...
const createModalHeader = () => {
    ...
    modalHeader.innerHTML = `
        <h2 class="text-[20px] md:text-[64px] font-medium text-white">Введите ваши данные</h2>
    `;
    return modalHeader;
};
...
const createModalForm = () => {
    ...
    modalForm.className = 'flex flex-col gap-[20px] md:gap-[60px]';
    ...
    modalForm.addEventListener('submit', (e) => {
        ...
        const modalHeader = modal.querySelector('.text-center');
        modalHeader.innerHTML = `
...
const createCloseButton = () => {
    ...
    closeModalButton.addEventListener('click', (e) => {
        e.stopPropagation();
        const modalBack = document.querySelector('.global-modal-back');
        const modal = document.querySelector('.global-modal');
...
const initGlobalModal = () => {
    ...
    const modalBack = createModalBack();
